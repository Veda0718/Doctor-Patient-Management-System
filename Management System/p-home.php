...
if(isset($_POST['update']))
{
  $usrnme=$_POST['uname'];
  $name=$_POST['name'];
  $query="UPDATE `patients` SET name='$_POST[name]',age='$_POST[age]',gender='$_POST[gender]',dob='$_POST[dob]',mail='$_POST[mailid]',address='$_POST[addr]' where user_name='$usrnme' ";
  //echo $query;
...
if (isset($_SESSION['id']) && isset($_SESSION['user_name'])) {
 ...
 <html lang="en" dir="ltr">
   ...
   <body>
     <?php
     include "d-db_conn.php";
      $query = "select * from patients where user_name=?";
     ...
     <center><h1 style="
       ...
       <div class="viewdetails" style="background-color: rgba(192,192,192,0.3);margin-left:30vw;margin-bottom:5vw;margin-top: 5vw;border-radius:10px;position:absolute;border:1px solid black;visibility:hidden;box-shadow: 5px 10px #404040;">
         <div class="photo" style="padding:30px;">
           <center><img src="images/patient.png" style="width:11vw;height:11vw;" onclick="closepatientsignupForm()"></center><br>
